...
const caption = ["Stay Updated About Your Health", "Check Your Results Online", "Manage Your Appointments"]
...
const PatientCaring: FC = () => {
    return (
        <section className="flex  justify-center py-10 gap-16 bg-blue-50 md:min-w-[450px]">
            ...
            <div className="flex flex-col md:w-1/3 md:my-20">
                <h6 className="text-primary">HELPING PATIENTS FROM AROUND THE GLOBE!!</h6>
                <h3 className={title({ color: "blue" })} >Patient <span className="text-primary">Caring</span></h3>
                <p className="my-4 text-default-600">Our goal is to deliver quality of care in a courteous, respectful, and compassionate manner. We hope you will allow us to care for you and strive to be the first and best choice for healthcare.</p>
                <ul className="flex flex-col gap-4">
                    {caption.map((data, i) => <li key={"patient-caring-caption-" + i} className="flex gap-4 items-center">
                        <StarCheck />
