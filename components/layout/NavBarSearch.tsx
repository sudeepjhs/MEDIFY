...
import React, { FC, FormEvent, Key, useEffect, useState } from "react";
  ...
  return (
    <div className="w-full h-28 relative rounded-b-2xl bg-gradient-to-r from-[#2AA7FF] to-[#0C8CE5]">
      <div className="flex items-center justify-center absolute  inset-0 top-3/4 z-20">
        <form onSubmit={onSearchClick} className="flex-wrap gap-4 md:flex-nowrap flex bg-primary-foreground rounded-2xl  shadow-xl items-center  w-4/5 p-6">
          <Autocomplete
